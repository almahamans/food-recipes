...
//edamam API
  ...
  <div className="bg-white">
    <form  className='flex flex-col justify-center items-center flex-grow relative '>
      ...
      <input type="text" name="food" id ="food" autoComplete='no' spellCheck='true' placeholder='ex rice...' value={search} onChange={(e) => setSearch(e.target.value)} className='rounded-md mb-3 mr-5 border-2 p-2 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 w-64' />
